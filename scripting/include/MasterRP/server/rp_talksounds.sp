...
float CanSay[MAXPLAYERS + 1] = {0.0,...};

public void initTalkSounds()
{
...
//Say Sounds menu:
public Action Commandsounds(int Client, int Args)
{
...
public bool CheckStringSound(int Client, const char[] Text)
{
...
public Action OnClientHurtSound(int Client)
{

	//Declare:
	char FormatSound[256]; 
	int Random = 0;
	float ClientOrigin[3];
