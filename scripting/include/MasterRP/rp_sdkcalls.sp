...
Handle hRemoveAllItems = INVALID_HANDLE;
...
public void initSDKTools()
{
	...
	PrepSDKCall_SetFromConf(GameData, SDKConf_Virtual, "RemoveAllItems");
	...
	if(hRemoveAllItems == INVALID_HANDLE)
	{
		...
		//Fail State:
		SetFailState("[SM] ERROR: Missing offset 'void CBaseCharicter::ExitVehicle( void )'");
	}
...
public void RemoveAllItems(int Client, bool Result)

{


	//Initulize:
	SDKCall(hRemoveAllItems, Client, boolToint(Result));
