...
public void SetErythroxylumHealth(int Client, int Id, int Amount)
{
...
public void ErythroxylumHud(int Client, int Ent, float NoticeInterval)
{
...
public void RemoveErythroxylum(int Client, int X)
{
	...
	//Check
	if(IsValidEdict(ErythroxylumEnt[Client][X]) && ErythroxylumEnt[Client][X] > GetMaxClients())
	{

		//Request:
		RequestFrame(OnNextFrameKill, ErythroxylumEnt[Client][X]);
	}
