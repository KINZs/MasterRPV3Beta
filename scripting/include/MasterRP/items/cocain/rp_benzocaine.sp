...
public void BenzocaineHud(int Client, int Ent, float NoticeInterval)
{
...
public void RemoveBenzocaine(int Client, int X)
{
	...
	//Check
	if(IsValidEdict(BenzocaineEnt[Client][X]) && BenzocaineEnt[Client][X] > GetMaxClients())
	{

		//Request:
		RequestFrame(OnNextFrameKill, BenzocaineEnt[Client][X]);
	}
