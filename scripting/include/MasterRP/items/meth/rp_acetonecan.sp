...
public void AcetoneCanHud(int Client, int Ent, float NoticeInterval)
{
...
public void RemoveAcetoneCan(int Client, int X)
{
	...
	//Check
	if(IsValidEdict(AcetoneCanEnt[Client][X]) && AcetoneCanEnt[Client][X] > GetMaxClients())
	{

		//Request:
		RequestFrame(OnNextFrameKill, AcetoneCanEnt[Client][X]);
	}
