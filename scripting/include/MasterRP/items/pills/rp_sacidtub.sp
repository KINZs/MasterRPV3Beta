...
public void initDefaultSAcidTub(int Client)
{
...
public int GetSAcidTubIdFromEnt(int Ent)
{
...
public void SAcidTubHud(int Client, int Ent, float NoticeInterval)
{
...
public Action RemoveSAcidTub(int Client, int X)
{
	...
	//Check
	if(IsValidEdict(SAcidTubEnt[Client][X]) && SAcidTubEnt[Client][X] > GetMaxClients())
	{

		//Request:
		RequestFrame(OnNextFrameKill, SAcidTubEnt[Client][X]);
	}
