...
public void PlasmaBombHud(int Client, int Ent, float NoticeInterval)
{
...
public void RemovePlasmaBomb(int Client, int X, bool Explode)
{
	...
	//Check
	if(IsValidEdict(PlasmaBombEnt[Client][X]) && PlasmaBombEnt[Client][X] > GetMaxClients())
	{

		//Request:
		RequestFrame(OnNextFrameKill, PlasmaBombEnt[Client][X]);
	}
