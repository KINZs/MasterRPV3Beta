...
public void BongHud(int Client, int Ent, float NoticeInterval)
{
...
public void RemoveBong(int Client, int X)
{
	...
	//Check
	if(IsValidEdict(BongEnt[Client][X]) && BongEnt[Client][X] > GetMaxClients())
	{

		//Request:
		RequestFrame(OnNextFrameKill, BongEnt[Client][X]);
	}
