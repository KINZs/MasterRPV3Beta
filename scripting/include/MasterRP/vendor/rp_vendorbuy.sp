		...
		if(IsInDistance(Client, Ent))
		{
			...
			if(IsValidComputer(Ent))
			{
				...
				if(GetItemAmount(Client, 459) == 0)
				{
					...
					//Print:
					CPrintToChat(Client, "\x07FF4040|RP|\x07FFFFFF You dont have enough \x0732CD32€%i\x07FFFFFF.", GetItemName(459));
				...
				else
				{
					...
					//Set Item
					SetItemAmount(Client, 459, (GetItemAmount(Client, 459) - 1));
				}
			}
